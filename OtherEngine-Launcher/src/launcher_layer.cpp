...
namespace other {
  ...
  void LauncherLayer::OnUIRender() {
    auto fe_option = [this](const std::string& option, FileExplorerType type, SelectionContextType context_type, std::optional<RenderState> transition_to = std::nullopt) {
