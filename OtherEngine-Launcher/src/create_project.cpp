...
namespace other {
  ...
  bool CreateProjectLayer::CreateProjectFolder() {
    ...
    std::filesystem::copy(engine_premake, premake, std::filesystem::copy_options::overwrite_existing | std::filesystem::copy_options::recursive);
    std::filesystem::copy_file(engine_make, make, std::filesystem::copy_options::overwrite_existing);
    std::filesystem::copy_file(engine_imguiini, imguiini, std::filesystem::copy_options::overwrite_existing);
