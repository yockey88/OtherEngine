...
namespace other {
  ...
  class VarDecl : public AstStmt {
   public:
    VarDecl(const Token& type, const Token& name, Ref<AstExpr> initializer = nullptr, bool is_const = false, bool is_global = false)
  ...
  class FunctionStmt : public AstStmt {
   public:
    FunctionStmt(const Token& name, const std::vector<FunctionParam>& params, const Token& type, const Ref<AstStmt>& body = nullptr)
