...
class Keyboard {
  public:
    ...
    inline bool LCtrlLayer() { 
      return Blocked(Key::KEY_LCTRL) || Held(Key::KEY_LCTRL);
    }
    inline bool RCtrlLayer() { 
      return Blocked(Key::KEY_RCTRL) || Held(Key::KEY_RCTRL);
    }

    inline bool LAltLayer() { 
      return Blocked(Key::KEY_LALT) || Held(Key::KEY_LALT);
    }
    inline bool RAltLayer() { 
      return Blocked(Key::KEY_RALT) || Held(Key::KEY_RALT);
    }

    inline bool LCtrlShiftLayer() { 
      return LCtrlLayer() && (Blocked(Key::KEY_LSHIFT) || Held(Key::KEY_LSHIFT));
    }
    inline bool RCtrlShiftLayer() { 
      return RCtrlLayer() && (Blocked(Key::KEY_RSHIFT) || Held(Key::KEY_RSHIFT));
    }

    inline bool LCtrlAltLayer() { 
      return LCtrlLayer() && (Blocked(Key::KEY_LALT) || Held(Key::KEY_LALT));
    }
    inline bool RCtrlAltLayer() { 
      return RCtrlLayer() && (Blocked(Key::KEY_RALT) || Held(Key::KEY_RALT));
    }

    inline bool LCtrlAltShiftLayer() { 
      return LCtrlLayer() && LAltLayer() && (Blocked(Key::KEY_LSHIFT) || Held(Key::KEY_LSHIFT));
    }
    inline bool RCtrlAltShiftLayer() { 
      return RCtrlLayer() && RAltLayer() && (Blocked(Key::KEY_RSHIFT) || Held(Key::KEY_RSHIFT));
    }
