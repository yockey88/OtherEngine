...
namespace widgets {
  ...
  bool DrawVec2Control(const std::string_view label , glm::vec2& value , bool& edited , 
                       float reset_val , float col_w , VectorAxis axes , const glm::vec2& v_min, const glm::vec2& v_max ,
                       float speed) {
    bool modified = false;
    ...
    modified = EditVec2(label , ImVec2(ImGui::GetContentRegionAvail().x - 8.f , ImGui::GetFrameHeightWithSpacing() + 8.f) , 
                        reset_val , edited , value , axes , speed , v_min , v_max);
  ...
  bool DrawVec3Control(const std::string_view label , glm::vec3& value , bool& edited , 
                       float reset_val , float col_w , VectorAxis axes , const glm::vec3& v_min, const glm::vec3& v_max ,
                       float speed) {
    bool modified = false;
  ...
  bool DrawVec4Control(const std::string_view label , glm::vec4& value , bool& edited , 
                       float reset_val , float col_w , VectorAxis axes , const glm::vec4& v_min, const glm::vec4& v_max ,
                       float speed) {
    bool modified = false;
    ...
    modified = EditVec4(label , ImVec2(ImGui::GetContentRegionAvail().x - 8.f , ImGui::GetFrameHeightWithSpacing() + 8.f) , 
                        reset_val , edited , value , axes , speed , v_min , v_max);
  ...
  bool EditVec4(const std::string_view label , ImVec2 size , float reset_val , bool& edited , glm::vec4& value ,
                VectorAxis axes , float speed , const glm::vec4& v_min , 
                const glm::vec4& v_max  , const char* format , ImGuiSliderFlags flags) {
    ImGui::BeginVertical((std::string(label) + "fr").data());
    bool changed = false;
    {
      const float spacing = 8.f;
