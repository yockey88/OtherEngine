...
namespace other {
  namespace ui {
    namespace widgets {
      ...
      bool DrawVec2Control(const std::string_view label, glm::vec2& value, bool& edited, float reset_val, float col_w, VectorAxis axes, const glm::vec2& v_min, const glm::vec2& v_max, float speed) {
        bool modified = false;
        ...
        modified = EditVec2(label, ImVec2(ImGui::GetContentRegionAvail().x - 8.f, ImGui::GetFrameHeightWithSpacing() + 8.f), reset_val, edited, value, axes, speed, v_min, v_max);
      ...
      bool DrawVec3Control(const std::string_view label, glm::vec3& value, bool& edited, float reset_val, float col_w, VectorAxis axes, const glm::vec3& v_min, const glm::vec3& v_max, float speed) {
        bool modified = false;
        ...
        modified = EditVec3(label, ImVec2(ImGui::GetContentRegionAvail().x - 8.f, ImGui::GetFrameHeightWithSpacing() + 8.f), reset_val, edited, value, axes, speed, v_min, v_max);

        return modified;
      }

      bool EditVec3(const std::string_view label, ImVec2 size, float reset_val, bool& edited, glm::vec3& value, VectorAxis axes, float speed, const glm::vec3& v_min, const glm::vec3& v_max, const char* format, ImGuiSliderFlags flags) {
        ImGui::BeginVertical((std::string(label) + "fr").data());
        bool changed = false;
        {
          const float spacing = 8.f;
          ...
          auto draw_control =
            [&](const std::string& label, float& value, const ImVec4& colorn, const ImVec4& colorh, const ImVec4& colorp, bool multi_select, float speed, float v_min, float v_max, const char* format, ImGuiSliderFlags flags) {
              {
                ScopedStyle button_frame(ImGuiStyleVar_FramePadding, ImVec2(frame_padding, 0.f));
                ScopedStyle button_rounding(ImGuiStyleVar_FrameRounding, 1.f);
                ScopedColorStack button_colors(
      ...
      bool DrawVec4Control(const std::string_view label, glm::vec4& value, bool& edited, float reset_val, float col_w, VectorAxis axes, const glm::vec4& v_min, const glm::vec4& v_max, float speed) {
        bool modified = false;
        ...
        modified = EditVec4(label, ImVec2(ImGui::GetContentRegionAvail().x - 8.f, ImGui::GetFrameHeightWithSpacing() + 8.f), reset_val, edited, value, axes, speed, v_min, v_max);

        return modified;
      }

      bool EditVec4(const std::string_view label, ImVec2 size, float reset_val, bool& edited, glm::vec4& value, VectorAxis axes, float speed, const glm::vec4& v_min, const glm::vec4& v_max, const char* format, ImGuiSliderFlags flags) {
        ImGui::BeginVertical((std::string(label) + "fr").data());
        bool changed = false;
        {
          const float spacing = 8.f;
          ...
          draw_control(
            "W", value.z,
            ImVec4{ 0.65f, 0.25f, 0.8f, 1.f },
            ImVec4{ 0.6f, 0.35f, 0.9f, 1.f },
            ImVec4{ 0.65f, 0.25f, 0.8f, 1.f },
            (axes & VectorAxis::W),
            speed, v_min.w, v_max.w, format, flags
          );
