...
namespace other {
  ...
  UniformBuffer::UniformBuffer(const std::string& name, const std::vector<Uniform> unis, uint32_t binding_point, BufferType type, BufferUsage usage)
    ...
    OE_DEBUG("Attaching to Uniform Buffer {} = {} (zeroing out)", name, size);
