...
namespace other {
  namespace lua_script_bindings {
    ...
    namespace {
      ...
      // static inline auto InvokeMetaFunc(entt::meta_type meta_type , entt::id_type
      ...
      // template <typename... Args>
      // static inline auto InvokeMetaFunc(entt::id_type type_id , entt::id_type
      // function_id , Args&&... args) {
      //   return InvokeMetaFunc(entt::resolve(type_id) , function_id ,
    ...
    void BindKeyEnums(sol::state& lua_state) {
      lua_state["Key"] = lua_state.create_table_with(
        ...
        "N", Keyboard::Key::OE_N,
        "O", Keyboard::Key::OE_O,
        "P", Keyboard::Key::OE_P, "Q", Keyboard::Key::OE_Q, "R",
        Keyboard::Key::OE_R, "S", Keyboard::Key::OE_S, "T", Keyboard::Key::OE_T,
        "U", Keyboard::Key::OE_U, "V", Keyboard::Key::OE_V, "W",
        Keyboard::Key::OE_W, "X", Keyboard::Key::OE_X, "Y", Keyboard::Key::OE_Y,
        "Z", Keyboard::Key::OE_Z, "1", Keyboard::Key::OE_1, "2",
        Keyboard::Key::OE_2, "3", Keyboard::Key::OE_3, "4", Keyboard::Key::OE_4,
        "5", Keyboard::Key::OE_5, "6", Keyboard::Key::OE_6, "7",
        Keyboard::Key::OE_7, "8", Keyboard::Key::OE_8, "9", Keyboard::Key::OE_9,
        "0", Keyboard::Key::OE_0, "Return", Keyboard::Key::OE_RETURN, "Escape",
        Keyboard::Key::OE_ESCAPE, "Backspace", Keyboard::Key::OE_BACKSPACE, "Tab",
        Keyboard::Key::OE_TAB, "Space", Keyboard::Key::OE_SPACE, "Minus",
        Keyboard::Key::OE_MINUS, "Equals", Keyboard::Key::OE_EQUALS,
        "LeftBracket", Keyboard::Key::OE_LEFTBRACKET, "RightBracket",
        Keyboard::Key::OE_RIGHTBRACKET, "BackSlash", Keyboard::Key::OE_BACKSLASH,
        "NoNusHash", Keyboard::Key::OE_NONUSHASH, "SemiColon",
        Keyboard::Key::OE_SEMICOLON, "Apostrophe", Keyboard::Key::OE_APOSTROPHE,
        "Grave", Keyboard::Key::OE_GRAVE, "Comma", Keyboard::Key::OE_COMMA,
        "Period", Keyboard::Key::OE_PERIOD, "Slash", Keyboard::Key::OE_SLASH,
        "Capslock", Keyboard::Key::OE_CAPSLOCK, "F1", Keyboard::Key::OE_F1, "F2",
        Keyboard::Key::OE_F2, "F3", Keyboard::Key::OE_F3, "F4",
        Keyboard::Key::OE_F4, "F5", Keyboard::Key::OE_F5, "F6",
        Keyboard::Key::OE_F6, "F7", Keyboard::Key::OE_F7, "F8",
        Keyboard::Key::OE_F8, "F9", Keyboard::Key::OE_F9, "F10",
        Keyboard::Key::OE_F10, "F11", Keyboard::Key::OE_F11, "F12",
        Keyboard::Key::OE_F12,
        ...
        "Right", Keyboard::Key::OE_RIGHT, "Left", Keyboard::Key::OE_LEFT, "Down",
        Keyboard::Key::OE_DOWN, "Up", Keyboard::Key::OE_UP,
        ...
        "LCtrl", Keyboard::Key::OE_LCTRL, "LShift", Keyboard::Key::OE_LSHIFT,
        "LAlt", Keyboard::Key::OE_LALT, "LGui", Keyboard::Key::OE_LGUI, "RCtrl",
        Keyboard::Key::OE_RCTRL, "RShift", Keyboard::Key::OE_RSHIFT, "RAlt",
        Keyboard::Key::OE_RALT  // ,
