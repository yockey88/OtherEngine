...
bool RenderMaterial(const std::string& title , other::Material& mat) {
  ...
  edited = edited || other::ui::widgets::DrawVec3Control("color" , temp_color , edited , 0.f , 100.f , other::ui::VectorAxis::ZERO ,
                                      { 0.f , 0.f , 0.f } , { 1.f , 1.f , 1.f } , 0.1f);
  other::ui::BeginProperty("shininess");
  edited = edited || other::ui::DragFloat("##shininess" , &mat.shininess , 0.5f , 0.f , 256.f);
...
bool RenderPointLight(const std::string& title , other::PointLight& pl) {
  ...
  edited = edited || other::ui::widgets::DrawVec3Control("ambient color" , temp_color , edited , 0.f , 100.f , other::ui::VectorAxis::ZERO ,
                                      { 0.f , 0.f , 0.f } , { 1.f , 1.f , 1.f } , 0.1f);
