...
class HostTests : public DoTest {
 ...
 protected:
  ...
  virtual void SetUp() {
    ...
    util::print(DO_STR("Native Object Handle: {:#08x}"sv), MessageLevel::DEBUG, native_object->object_handle);
  }
 ...
 public:
  static void* GetVec3() {
    util::print(DO_STR("Getting Native Object Handle: {:#08x} (address : {:p})"sv), MessageLevel::DEBUG, native_object->object_handle, fmt::ptr(&native_object));
    return &vec;
  }
