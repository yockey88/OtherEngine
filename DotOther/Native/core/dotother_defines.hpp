/**
 * \file core/dotother_defines.hpp 
 **/
#ifndef DOTOTHER_NATIVE_DOTOTHER_DEFINES_HPP
#define DOTOTHER_NATIVE_DOTOTHER_DEFINES_HPP
...
#endif // !DOTOTHER_NATIVE_DOTOTHER_DEFINES_HPP
